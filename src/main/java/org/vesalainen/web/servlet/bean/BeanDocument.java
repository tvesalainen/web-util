...
public class BeanDocument<C> extends Document
{
    ...
    public class BeanForm extends Form
    {
        ...
        private boolean hasHideScript;

        public BeanForm(Document document, String action)
        {
            this(document, "post", action);
        }
        public BeanForm(Document document, String method, String action)
        {
            super(method, action);
        ...
        {
            addHideScript();
            Class type = BeanHelper.getType(context, field);
            if (Collection.class.isAssignableFrom(type))
            {
                InputType inputTypeAnnotation = BeanHelper.getAnnotation(context, field, InputType.class);
        ...
        public Content createInput(String field)
        {
            ...
            Class type = BeanHelper.getType(context, field);
            Object value = BeanHelper.getFieldValue(context, field);
            InputType inputTypeAnnotation = BeanHelper.getAnnotation(context, field, InputType.class);
            if (inputTypeAnnotation != null)
            {
        ...
        protected Element multipleSelectorContainer(String field, String inputType, Object value, String labelText, String placeholder, InputType inputTypeAnnotation)
        {
            ...
            MultipleSelectorInput<C,Object> input = new MultipleSelectorInput<>(threadLocalData, dataType, field, options);
            fieldMap.put(field, input);
            Element fieldSet = new Element("fieldset");
            fieldSet.addElement("label")
        ...
        protected Element singleSelectorContainer(String field, String inputType, Object value, String labelText, String placeholder, InputType inputTypeAnnotation)
        {
            ...
            List options = selector.getOptions();
            SingleSelectorInput<C,Object> input = new SingleSelectorInput<>(threadLocalData, dataType, field, options);
            fieldMap.put(field, input);
            Element fieldSet = new Element("fieldset");
            fieldSet.addElement("label")
                    .addText(getLabel(field));
